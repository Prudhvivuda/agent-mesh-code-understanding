...
| 3 | Gemma-4-31B-it OR gpt-oss-120b | Coding agent (for invoking skills) | <ul><li>[deploying-gemma-4-31b.md](resources/models/deploying-gemma-4-31b.md)</li><li>[deploying-gpt-oss-120b.md](resources/models/deploying-gpt-oss-120b.md)</li></ul> | — |
