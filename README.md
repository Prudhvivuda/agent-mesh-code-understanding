...
| # | Model | Role | Additional Instructions | Documentation |
|---|-------|------|------------------------|---------------|
| 1 | gpt-oss-120b | GraphRAG "chat" model | [deploying-gpt-oss-120b.md](resources/models/deploying-gpt-oss-120b.md) | <a href="https://microsoft.github.io/graphrag/config/yaml" target="_blank">Link</a> |
| 2 | e5-mistral-7b-instruct | GraphRAG "embedding" model | [deploying-e5-mistral-7b-instruct.md](resources/models/deploying-e5-mistral-7b-instruct.md) | <a href="https://microsoft.github.io/graphrag/config/yaml" target="_blank">Link</a> |
| 3 | Gemma-4-31B-it (Option A) | Coding agent (for invoking skills) | [deploying-gemma-4-31b.md](resources/models/deploying-gemma-4-31b.md) | — |
| 4 | gpt-oss-120b (Option B) | Coding agent (for invoking skills) | [deploying-gpt-oss-120b.md](resources/models/deploying-gpt-oss-120b.md) | — |
